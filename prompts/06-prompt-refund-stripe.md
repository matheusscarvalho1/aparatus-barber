...
- Após isso, no caso de cancelamento de reserva, faça o estorno no Stripe em @app_actions\cancel-booking.ts. Use Context7 para buscar na documentação do Stripe como fazer isso.
